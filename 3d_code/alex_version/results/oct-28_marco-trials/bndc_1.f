...
*
        ELSE
         ...
         AUT(L,L,I,J,K) = 1.0         
         AUP(L,L,I,J,K) = 1.0
         BU(L,I,J,K) = 0.0 !DKTP(K)*(P(I,J,KB)-P(I,J,KB+1))/DKTP(KB)
*         BU(L,I,J,K) = 0.0
        ENDIF
*
*     Top face boundary conditions
...
*        
        ELSE
         ...
         AUT(L,L,I,J,K) = 0.0         
         AUP(L,L,I,J,K) = 1.0
         BU(L,I,J,K) = 0.0 !DKTP(KE)*(P(I,J,KE)-P(I,J,KE-1))/DKTP(KE-1)
*         BU(L,I,J,K) = 0.0
        ENDIF
*
 25    CONTINUE
