...
*
      ...
      REAL*8 RHO0,COND0,CP0,VISC0,BETA0,ITIME,DTIME,CRIT,TCRIT        !
...
*
     ...
     C                 IRATZ1,IRATZ2,IRATZ3,IRATZ4 
      READ(IDATI,5020) RHO0,COND0,CP0,VISC0,BETA0             !
     ...
     C                 TCRIT
      ...
      READ(IDATI,5070) CONDFE0,CONDSX,CONDSY,CONDSZ,CSP,RHOSP,ASF !
